  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-gray-900 rounded-3xl p-6 w-full max-w-sm shadow-2xl relative overflow-hidden text-center space-y-6 animate-in zoom-in-95 duration-300 border border-gray-800">
        ...
        <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-green-neon/10 to-transparent pointer-events-none"></div>
        
        <div className="relative">
             <div className="w-20 h-20 bg-green-neon rounded-full mx-auto flex items-center justify-center shadow-lg mb-4">
             ...
             <p className="text-green-neon font-bold mt-1">@naira9ja001</p>
        </div>
