        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 space-y-4 relative overflow-hidden">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center border-b border-gray-50 pb-2">
              ...
              <span className="text-lg font-black text-black uppercase tracking-tighter">Smartcash</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-xs text-gray-400 uppercase font-bold">Account Name</span>
              <span className="text-sm font-black text-black uppercase tracking-tighter">RABIU ABDULLAHI</span>
            </div>
          </div>
